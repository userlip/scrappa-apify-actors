...
export function getVintedItems(response: VintedUserItemsResponse): VintedItem[] {
...
export function getVintedPagination(response: VintedUserItemsResponse): VintedPagination | undefined {
...
export function buildVintedDatasetItem(
    ...
    response: VintedUserItemsResponse,
