export interface LinkedInJobDetailsRequestInput {
    url: string;
    use_cache?: boolean;
    maximum_cache_age?: unknown;
}

export function buildLinkedInJobDetailsParams(input: LinkedInJobDetailsRequestInput): Record<string, unknown> {
