...
test('counts only the route-result charge when Apify includes the synthetic dataset charge', async () => {
    const mock = actor({ result: { chargedCount: 2, eventChargeLimitReached: false } });
    const writer = createChargedRouteWriter(mock, mock);
