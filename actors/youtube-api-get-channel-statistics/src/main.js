...
Actor.main(async () => {
    ...
    if (successCount === 0) {
        throw new Error(`Failed to fetch statistics for all ${failureCount} channel(s).`);
    }

    console.log(`Successfully fetched statistics for ${successCount} channel(s); ${failureCount} failed.`);
