export interface GoogleTrendsInterestInput {
    q?: unknown;
    geo?: unknown;
    time_range?: unknown;
    hl?: unknown;
...
export function buildGoogleTrendsInterestParams(input: GoogleTrendsInterestInput): Record<string, unknown> {
    const params: Record<string, unknown> = {
        q: cleanRequiredString(input.q, 'q', 100),
    };
...
export function describeGoogleTrendsInterestRequest(params: Record<string, unknown>): string {
