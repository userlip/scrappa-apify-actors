export interface TikTokUserPostsInput {
    profile?: unknown;
    unique_id?: unknown;
    user_id?: unknown;
    count?: unknown;
...
export function formatTikTokUserPostsLookupForLog(input: TikTokUserPostsInput): string {
...
export function buildTikTokUserPostsParams(
    input: TikTokUserPostsInput,
