...
- [ ] Confirm the live inventory count against the README before starting the audit; the 2026-05-23T05:01Z baseline on this branch is 70 live actors, 60 public actors, 62 local actor manifests, and 8 missing local source directories. Recent public actor coverage in this baseline includes `immobilienscout24-search-scraper` (`601ilBYtO52NNsMrT`), `redfin-property-search-scraper` (`Xa9ClmgD4tI9lHT91`), and `kleinanzeigen-search-scraper` (`OTzcE9BHg83MpDprO`).
