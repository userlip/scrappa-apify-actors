...
| `actors/google-maps-directions-scraper` | `google-maps-directions-scraper` | `ZF8jFdzF15k49AZQh` | Google Maps Directions Scraper | Local source present; live Apify version uses `SOURCE_FILES` | Active `PAY_PER_EVENT` pricing at `$0.0005` per `route-result`; verify `currentPricingInfo` |
