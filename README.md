...
|---|---|---|---|---|---|
| `actors/arbeitsagentur-jobs-scraper` | `arbeitsagentur-jobs-scraper` | `EiUCYz2MjYUuGT6Xu` | Arbeitsagentur Jobs Scraper ($0.30/1k results) | Local source present; live Apify version uses `SOURCE_FILES`; QA retry hardening deployed as build `1.0.6`; exact-prefill run `SjEyjWBSCiaqEkZeR` succeeded with 25 dataset items in 9.747 seconds; maintenance notice cleared 2026-08-30 | Active `PAY_PER_EVENT`, default dataset job result at $0.0003/result |
